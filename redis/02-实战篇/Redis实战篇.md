...
[十分钟彻底掌握缓存击穿、缓存穿透、缓存雪崩 - 三分恶 - 博客园 (cnblogs.com)](https://www.cnblogs.com/three-fighter/p/15253451.html)
...
1. 可重入: 利用hash结构记录线程id和重入次数, 和jdk里的reentrylock一样;
2. 可重试: 利用信号量和PubSub功能实现等待、唤醒, 获取锁失败的重试机制;
3. 超时续约: 利用watchDog, 每隔一段时间(releaseTime/3)重置超时时间

<img src="assets/image-20230614163101069.png" alt="image-20230614163101069" style="zoom: 50%;" />
